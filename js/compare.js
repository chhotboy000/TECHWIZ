...
(function ($) {
    ...
    $(document).on('click', '.cmprBtn', function () {
        if ($(".cmprBtn").hasClass("active")) {
            ...
            $(".contentPop").append('<div class="col-sm-3 compareItemParent relPos">' + '<ul class="product">' + '<li class="relPos compHeader"><p class="w3-display-middle">Features</p></li>' + '<li>Name<br></li>' + '<li>Price</li>'  + '<li>water</li>' + '<li>light</li>' + '<li>species</li>' + '<li>height</li>' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                /*appending to div*/
                $(".contentPop").append(' <div class="col-sm-3 compareItemParent relPos">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + title + '</li>' + '<li>' + '$' + $(product).data('price') + '</li>' + '<li>' + $(product).data('water') + '</li>' + '<li>' + $(product).data('light') + '</li>' + '<li>' + $(product).data('species') + '</li>' + '<li>' + $(product).data('height') + '</li>' + '</ul>' + '</div>');
            }
        }
        $(".modPos").show();
    });
